...
namespace Siren.MobileAppService.Migrations
{
    ...
    [Migration("20200523075145_AddedChatTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Siren.Contracts.Models.Chat.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Siren.Contracts.Models.Chat.ConversationUser", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("Siren.Contracts.Models.Chat.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Siren.Contracts.Models.Chat.ConversationUser", b =>
                {
                    b.HasOne("Siren.Contracts.Models.Chat.Conversation", "Conversation")
            ...
            modelBuilder.Entity("Siren.Contracts.Models.Chat.Message", b =>
                {
                    ...
                    b.HasOne("Siren.Contracts.Models.Identity.User", "SentBy")
                        .WithMany()
                        .HasForeignKey("SentById1");
                });
